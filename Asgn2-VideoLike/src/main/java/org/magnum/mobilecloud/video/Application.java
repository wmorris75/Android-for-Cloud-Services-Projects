...
@Import(OAuth2SecurityConfiguration.class)     //TODO: Import the OAuthSecurityConfiguration.class
public class Application extends RepositoryRestMvcConfiguration {
	...
	//Remove the embedded customizer container and leave it in the OAuthSecurityConfiguration file
	/*
    @Bean
