...
private List<Video>video = new CopyOnWriteArrayList<Video>();
	private VideoStatus videoStatus;
	private Video vid;
	private VideoSvcApi videoSvc;
	private VideoFileManager videoDataMgr;	
...
private static final AtomicLong currentId = new AtomicLong(0L);
	...
	public @ResponseBody VideoStatus setVideoData(@PathVariable("id") long id, final @RequestParam("data") MultipartFile videoData, HttpServletResponse response){
		if(videos.containsKey(vid.getId()) ){
	...
	@RequestMapping(value=VideoSvcApi.VIDEO_DATA_PATH, method=RequestMethod.GET)
  	public @ResponseBody void serveSomeVideo(Video v, HttpServletResponse response) throws IOException {
  	     // Of course, you would need to send some headers, etc. to the
  	     // client too!
  	     //  ...
